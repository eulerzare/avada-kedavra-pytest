...
class Iface(object):
    def addAccount(self, addAccount):
        """
        Parameters:
         - addAccount
...
class Processor(Iface, TProcessor):
    ...
    def process_addAccount(self, seqid, iprot, oprot):
        ...
        result = addAccount_result()
        try:
            result.success = self._handler.addAccount(args.addAccount)
...
class addAccount_args(object):
    ...
    def __init__(self, addAccount=None,):
    ...
    def write(self, oprot):
        ...
        if self.addAccount is not None:
            oprot.writeFieldBegin('addAccount', TType.STRUCT, 1)
            self.addAccount.write(oprot)
            oprot.writeFieldEnd()
...
addAccount_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'addAccount', [AddAccount, None], None, ),  # 1
)
