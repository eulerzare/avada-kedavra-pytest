...
class AddCurrencyResponse(object):
    """
    Attributes:
     - status
     - message
    ...
    def __init__(self, status=None, message=None, currencyId=None,):
        self.status = status
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('AddCurrencyResponse')
        ...
        if self.currencyId is not None:
            oprot.writeFieldBegin('currencyId', TType.I64, 3)
            oprot.writeI64(self.currencyId)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
all_structs.append(AddCurrencyResponse)
AddCurrencyResponse.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'status', None, None, ),  # 1
    (2, TType.STRING, 'message', 'UTF8', None, ),  # 2
    (3, TType.I64, 'currencyId', None, None, ),  # 3
)
